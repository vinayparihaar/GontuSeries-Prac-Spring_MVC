...
public class StudentInfoRESTAPIController {
	...
	// ********************** Getting/Retrieving All Student record ********************** 
	...
	// ********************** Getting/Retrieving particular Student record **********************
	...
	public ResponseEntity<Boolean> updateStudent(@PathVariable("name") String studentName,
		...
		// update the matching student record with the information of the student sent by the client.
	...
	@RequestMapping(value = "/students/{name}", method = RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	// ********************** Deleting All Students record **********************
		...
		public ResponseEntity<Boolean> deleteAllStudent() {
			...
			// Deletes all student record from database.
			System.out.println("All students recors deleted.");
