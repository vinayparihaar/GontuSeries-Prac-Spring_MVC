...
public class Student {
	...
	/*
	 * @Size(min = 2,max = 30, message = "*Student Hobby must be between 2 to 30 characters.")
	 */
	@Size(min = 2,max = 30, message = "*Student Hobby must be between {min} to {max} characters.")
